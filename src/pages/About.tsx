      ...
      <div className="min-h-screen bg-ivory">
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl font-bold text-center mb-12 text-espresso">About Me</h1>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold text-espresso mb-4">Hello, I'm a Creative Developer</h2>
            ...
            {/* Skills Section */}
            <div className="mt-16">
              <h2 className="text-3xl font-bold text-center mb-8 text-espresso">Skills & Technologies</h2>
            ...
            <div className="mt-16">
              <h2 className="text-3xl font-bold text-center mb-8 text-espresso">Contact & Socials</h2>
